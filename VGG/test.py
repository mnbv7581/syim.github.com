...
print(vgg)
Image_name = '0_airbus_s_001477.png'
Image_name_pars = Image_name.split('_')
img = cv2.imread('./test/0_airbus_s_001477.png')
list_input_var = []
list_label_var = []
...
#output = sess.run(vgg,feed_dict={input_var : [img], training_flag : False}) # 입력에 따른 vgg에대한 결과를 리턴
