...
from Learnit.ResNet.utils import *

from Learnit.ResNet.Define import *
from Learnit.ResNet.ResNet import *
...
if __name__ == '__main__':
    ...
    resnet = ResNet(input_var, training_flag)

    learning_rate = tf.placeholder(tf.float32, name = 'learning_rate')
    
    #loss
    ce = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels = label_var, logits = resnet))
    ...
    with tf.Session() as sess:
        ...
        #saver.restore(sess, model_path + model_name.format(10000))
        ...
        for epoch in range(1, MAX_EPOCHS+1):
            ...
            #train
            for train_name in train_names[:BATCH_SIZE + 5]:
